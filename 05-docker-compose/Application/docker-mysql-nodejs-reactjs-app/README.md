...
1. setup database with public image
2. setup backend with Dockerfile
3. setup frontend with Dockerfile
4. Start the Docker
5. create docker-compose file
6. Build and start the services: `docker-compose up --build`
7. stop the service: `docker-compose down`

### Stop the System

- If you need to stop and remove all containers, networks, and all images used by any service in docker-compose.yml file.
